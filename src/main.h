...
static const int64_t MAX_MONEY = 1235813.2134 * COIN;
static const int64_t COIN_YEAR_REWARD = 1 * CENT; // 1% Adjusted in main.cpp
...
static const uint256 hashGenesisBlock("0x00000330ed10b2321761201ecbd37dd2058835334069fe5bfc5ec1eb5a59891e");
